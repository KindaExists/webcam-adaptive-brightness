...
class Core:
    ...
    def setup_external(self):
        ...
        self.webcam_device_id = self.configs.get_setting('device_id')
        self.webcam.open(self.webcam_device_id)
    ...
    def update_webcam_device(self):
        setting_device_id = self.configs.get_setting('device_id')
        if self.webcam_device_id != setting_device_id:
            self.webcam.release()
            self.webcam.open(setting_device_id)
