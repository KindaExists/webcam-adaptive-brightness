...
settings = Frame(header,width=100,height=30,bg=black,highlightbackground=fgColor,highlightthickness=0,cursor='hand2')
settings.pack_propagate(0)
settingsButton=Button(settings, font=("Bahnschrift SemiBold",10), bg=lightGrey,fg='#FFFFFF',text = "SETTINGS", padx=20,pady=10, command = opensettings,
...
middle= Canvas(root, highlightbackground=fgColor, bg=grey, highlightcolor=fgColor, highlightthickness=1, width=880, height=385, bd= 0)
...
bottom= Frame(root, highlightbackground=fgColor, bg=grey, highlightcolor=fgColor, highlightthickness=1, width=880, height=55, bd= 0)
